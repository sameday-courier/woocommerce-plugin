...
final class RemoveBulkAwbModal
{
    ...
    public static function render(): string
    {
        ...
        $removedLabel = TranslatorHandler::translate('Removed');
        $removedHint = TranslatorHandler::translate('Successfully removed');
        ...
        $button = sprintf(
            '<a id="%1$s"
                ...
                style="display:none;"
                role="button"
                data-sameday-bulk-awb-open="%2$s">%3$s%4$s</a>',
        ...
        $modal = sprintf(
            '<div id="%1$s"
                  ...
                  data-sameday-bulk-awb-mode="remove">
                    ...
                    <div class="sameday-bulk-awb-modal__header">
                        <div class="sameday-bulk-awb-modal__heading">
                            <div class="sameday-bulk-awb-modal__icon"
                                 ...
                                 aria-hidden="true">
                                %22$s
                                <svg class="sameday-bulk-awb-modal__icon-svg sameday-bulk-awb-modal__icon-svg--success"
                                     viewBox="0 0 24 24"
                                     width="22"
                                     height="22"
                                     fill="none"
                        ...
                        <div data-sameday-bulk-awb-step="starting" hidden>
                            <div class="sameday-bulk-awb-modal__starting">
                                ...
                                <p class="sameday-bulk-awb-modal__starting-text"
                                   data-sameday-bulk-awb-starting-text>%10$s</p>
                            </div>
                        </div>
        ...
        $modal = str_replace(
            ...
            sprintf(
                'data-sameday-bulk-awb-mode="remove"'
                . ' data-progress-title="%1$s"'
                . ' data-starting-title="%2$s"'
                . ' data-report-title="%3$s"'
                . ' data-report-subtitle="%4$s"'
                . ' data-confirm-title="%5$s"'
                . ' data-confirm-subtitle="%6$s"',
