...
final class RemoveBulkAwbModal
{
    ...
    public static function render(): string
    {
        ...
        $modal = sprintf(
            '<div id="%1$s" class="sameday-bulk-awb-modal" hidden data-sameday-bulk-awb-modal data-sameday-bulk-awb-mode="remove">
        ...
        $modal = str_replace(
            ...
            sprintf(
                'data-sameday-bulk-awb-mode="remove" data-progress-title="%1$s" data-starting-title="%2$s" data-report-title="%3$s" data-report-subtitle="%4$s" data-confirm-title="%5$s" data-confirm-subtitle="%6$s"',
